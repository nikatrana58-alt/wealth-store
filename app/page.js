  ...
  return (
    <main className="min-h-screen bg-[#020617] text-white overflow-hidden selection:bg-purple-500 selection:text-white">
      ...
      <section className="max-w-7xl mx-auto px-5 py-32">
        ...
        {error ? (
          <div className="glass rounded-5xl p-8 border border-red-500/20 text-center text-red-200">
            <h3 className="text-2xl font-black">Could not load products</h3>
            <p className="text-red-200/70 mt-2">{error}</p>
          </div>
        ) : (
            ...
            {loading ? (
              ...
              >
                ...
                <p className="text-gray-600 mt-2">
                  Try adjusting your filters for more luxury.
                </p>
              </motion.div>
            ) : (
              <motion.div key="grid">
